                              ...
                              <Form.Group className="form-group">
                                ...
                                <InputGroup className="mb-3">
                                  <InputGroup.Text className="sign-icon">
                                    ...
                                    >
                                      <path
                                        d="M1 15C1 12.172 1 10.757 1.7911 9.879C2.5813 9 3.8548 9 6.4 9H13.6C16.1452 9 17.4187 9 18.2089 9.879C19 10.757 19 12.172 19 15C19 17.828 19 19.243 18.2089 20.121C17.4187 21 16.1452 21 13.6 21H6.4C3.8548 21 2.5813 21 1.7911 20.121C1 19.243 1 17.828 1 15Z"
                                        stroke="#A3A3A3"
                                        strokeWidth="1.5"
                                      />
                                      <path
                                        d="M4 9V7C4 5.4087 4.63214 3.88258 5.75736 2.75736C6.88258 1.63214 8.4087 1 10 1C11.5913 1 13.1174 1.63214 14.2426 2.75736C15.3679 3.88258 16 5.4087 16 7V9"
                                        stroke="#A3A3A3"
                                        strokeWidth="1.5"
                                        strokeLinecap="round"
                                      />
                                      <path
                                        d="M6 15H6.009M9.991 15H10M13.991 15H14"
                                        stroke="#A3A3A3"
                                        strokeWidth="2"
                                        strokeLinecap="round"
                                  ...
                                  />
                                  <InputGroup.Text
                                    className="sign-eyeIcon"
                                    onClick={handleShowPassword}
                                    style={{ cursor: "pointer" }}
                                  >
                                    {showPassword ? (
                                      <img src="/assets/images/solar_eye-outline.svg" />
                                    ) : (
                                      <img src="/assets/images/eye-slash.svg" />
                                    )}
                                  </InputGroup.Text>
                                  {/* <Form.Control.Feedback type="invalid">
                                    {errors.password && touched.password}
