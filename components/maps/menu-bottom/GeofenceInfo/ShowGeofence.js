    ...
    try {
      ...
      if (dataLength) {
        if (response?.data?.geofence[0].GeoFenceType === 1) {
          ...
          const GeofenceCenterPointLat =
            +GeofenceCenterPoint.split(",")[0].slice(1);
          const GeofenceCenterPointLng = +GeofenceCenterPoint.split(
            ","
          )[1].slice(0, -1);
          ...
          const GeofenceBoundsLat1 = +GeofenceBounds.split("|")[0]
            .split(",")[0]
            .slice(1);
          const GeofenceBoundsLng1 = +GeofenceBounds.split("|")[0]
            .split(",")[1]
            .slice(0, -1);

          const GeofenceBoundsLat2 = +GeofenceBounds.split("|")[1]
            .split(",")[0]
            .slice(1);
          const GeofenceBoundsLng2 = +GeofenceBounds.split("|")[1]
            .split(",")[1]
            .slice(0, -1);

          const GeofenceBoundsLat3 = +GeofenceBounds.split("|")[2]
            ?.split(",")[0]
            ?.slice(1);
          const GeofenceBoundsLng3 = +GeofenceBounds.split("|")[2]
            ?.split(",")[1]
            ?.slice(0, -1);

          const GeofenceBoundsLat4 = +GeofenceBounds.split("|")[3]
            ?.split(",")[0]
            ?.slice(1);
          const GeofenceBoundsLng4 = +GeofenceBounds.split("|")[3]
            ?.split(",")[1]
            ?.slice(0, -1);
          ...
          myMap?.setView([GeofenceBounds[0][0], GeofenceBounds[3][1]], 7);
        } else if (response?.data?.geofence[0].GeoFenceType === 2) {
          myMap?.setView(
            [
              response.data.geofence[0]?.GeofencePath[0][0],
              response.data.geofence[0]?.GeofencePath[2][1],
            ],
            6
          );
        }
